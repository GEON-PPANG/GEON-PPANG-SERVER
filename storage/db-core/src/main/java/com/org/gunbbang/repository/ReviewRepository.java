...
public interface ReviewRepository extends JpaRepository<Review,Long> {
    ...
    List<Review> findBestReviews(@Param("currentMemberBreadType") BreadType currentMemberBreadType,
                    @Param("currentMemberMainPurpose") MainPurpose mainPurpose);

    @Query(value = "SELECT distinct new com.org.gunbbang.BestReviewDTO(" +
            "b.bakeryId, " +
            "b.bakeryName, " +
            "b.bakeryPicture, " +
            "b.isHACCP, " +
            ...
            "ORDER BY r.createdAt desc")
    List<BestReviewDTO> findBestReviewDTOList (@Param("currentMemberBreadType") Long currentMemberBreadType,
                                               @Param("currentMemberMainPurpose") MainPurpose mainPurpose,
    ...
    @Query(value = "SELECT distinct new com.org.gunbbang.BestReviewDTO(" +
            ...
            "ORDER BY r.createdAt desc")
    List<BestReviewDTO> findRestBestReviewDTOListByBreadType(@Param("alreadyFoundReviews") List<Long> alreadyFoundReviews, PageRequest pageRequest);
}
