...
public enum ErrorType {
  ...
  NOT_EXPIRED_ACCESS_TOKEN_EXCEPTION(HttpStatus.UNAUTHORIZED, "만료되지 않은 엑세스 토큰입니다"),
  ...
  LOGIN_FAIL_EXCEPTION(HttpStatus.UNAUTHORIZED, "로그인에 실패하였습니다. 아이디나 비밀번호 확인해주세요"),
