package com.org.gunbbang.support.errorType;
...
public enum ErrorType {
  ...
  REQUEST_ISNOTLIKE_KEYWORDLIST_VALIDATION_EXCEPTION(
      HttpStatus.BAD_REQUEST, "아쉬워요 리뷰 시 키워드를 선택할 수 없습니다"),
  ...
  NO_APPLE_REFRESH_HEADER_EXCEPTION(
      HttpStatus.BAD_REQUEST, "애플 회원탈퇴 시 Apple-refresh 헤더 값이 오지 않았습니다. memberId: "),
